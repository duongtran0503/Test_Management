...
public class QuestionBLL {
    ...
    public Response.QuestoinResult getQuestoinResult(int page,int questionsPerPage) {
       Response.QuestoinResult res = questionDAL.getQuestoinResult(page,questionsPerPage);
        return  res;
    }
    
    public Response.TopicResult getTopic() {
      Response.TopicResult res = questionDAL.getTopic();
      return  res;
    }
    
    public Response.QuestoinResult searchQuestionByTitle(String tilte) {
       Response.QuestoinResult res = questionDAL.searchQuestionByTitle(tilte);
       return  res;
    }
    
    public Response.QuestoinResult searchQuestionByTitleAndTopic(String title,int topic) {
         Response.QuestoinResult res = questionDAL.searchQuestionByTitleAndTopic(title, topic);
         return  res;
    }
    
   public Response.QuestoinResult addQuestoin(QuestionDTO questionDTO, ArrayList<OptionDTO> listOption){
      Response.QuestoinResult res = questionDAL.AddQuestoin(questionDTO, listOption);
      return  res;
   }
   
    public Response.QuestoinResult updateQuestoin(QuestionDTO questionDTO, ArrayList<OptionDTO> listOption){
      Response.QuestoinResult res = questionDAL.updateQuestion(questionDTO, listOption);
      return  res;
   }
    
   public Response.QuestoinResult deleteQuestion(int id) {
      Response.QuestoinResult res = questionDAL.delelteQuestoin(id);
      return  res;
   }
  ...
  System.out.println("run7");
    ...
    public Response.QuestoinResult getQuestionDeleted() {
      Response.QuestoinResult res = questionDAL.getQuestionDeleted();
      return  res;
    }
    
    public Response.QuestoinResult recoverQuestion(int id) {
      Response.QuestoinResult res = questionDAL.recoverQuestion(id);
      return  res;
    }
    
    public Response.QuestoinResult filterQuestionsResult(String difficulty,int TopicId) {
      Response.QuestoinResult res = questionDAL.filterQuestionBydifficulty(difficulty, TopicId);
      return  res;
    }
