...
public class AdminCreateTestScreen extends javax.swing.JFrame {
    ...
    private void setInforQueston(int topicId) {
       Response.QuestoinResult easyQuestions = questionController.filterQuestionsResult(QuestionDTO.EASY,topicId);
        Response.QuestoinResult MeddiumQuestions = questionController.filterQuestionsResult(QuestionDTO.MEDIUM,topicId);
         Response.QuestoinResult DiffQuestions = questionController.filterQuestionsResult(QuestionDTO.DIFFICULT,topicId);
   ...
   private  void setValueSelectNameTest() {
    this.examData =this.examController.getExamResult();
   ...
   private  void setValueSelectTopic()  {
      this.topicResult= this.questionController.getTopic();
       DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>();
 ...
 private boolean validateData() {
    ...
    try {
        ...
        if (numberQuestion <= 0 || easyQ < 0 || mediumQ < 0 || diffQ < 0 || timeTest <= 0) {
 ...
 private  void createNewTest() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      if(status.equalsIgnoreCase("new")) {
       ...
       Response.BaseResponse res = examController.createNewTest(test, topicValue, listExamCod, easyQ, meddiumQ, diffQ);
       if(res.isIsSuccess()) {
       ...
       int meddiumQ = Integer.parseInt( this.mediumQConfirm.getText());
       int diffQ = Integer.parseInt( this.diffQCofirm.getText());
        Response.BaseResponse res = this.examController.addNewExamCode(test, listExamCod, easyQ, meddiumQ, diffQ);
         if(res.isIsSuccess()) {
        JOptionPane.showMessageDialog(null, res.getMessage());
        dispose();
       }else {
