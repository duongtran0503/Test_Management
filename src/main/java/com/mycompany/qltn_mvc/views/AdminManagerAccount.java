 ...
 * @author ACER
 */
public class AdminManagerAccount extends javax.swing.JFrame {
    ...
    if (confirm == JOptionPane.YES_OPTION) {
           Response.BaseResponse res = userController.deleteUser(user.getUserId());
        if(res.isIsSuccess()) {
    ...
    private  void loadUsers() {
     Response.UserResult res = userController.getUser(UserDTO.IS_DELETED_FALSE);
     if(res.isIsSuccess()) {
      ...
      private void exportExcel() {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            if (!filePath.toLowerCase().endsWith(".xlsx")) {
               ...
               Response.BaseResponse res = userController.exportToExcel(this.userData.getUserList(), filePath);
          if(res.isIsSuccess()) {
            JOptionPane.showMessageDialog(null, res.getMessage());
          } else {
          JOptionPane.showMessageDialog(null, res.getMessage());
    ...
    private void searchUser() {
      ...
      Response.UserResult res = userController.searResult(searchKey);
      if(res.isIsSuccess()) {
          displayDataOnTable(res);
      }else {
       JOptionPane.showMessageDialog(null, res.getMessage());
    ...
    private void initComponents() {
        ...
        jButton2.setText("Export file excel");
        ...
        jButton3.setPreferredSize(new java.awt.Dimension(84, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminManagerAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminManagerAccount().setVisible(true);
            }
        });
    }
