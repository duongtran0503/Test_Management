...
import com.mycompany.qltn_mvc.UI.CheckboxTableModel;
...
Object[][] dataArray = data.toArray(Object[][]::new);
    ...
    this.jTable1.setModel(checkboxTableModel);
       ...
       private void loadQuestion() {
        Response.QuestoinResult res = questionController.getQuestoinResult(0, 20);
    ...
    int topic = selectTopic.getSelectedIndex();
     ...
     if(topic !=0) {
       Response.QuestoinResult res = questionController.searchQuestionByTitleAndTopic(searchKey, topic);
         if(res.isIsSuccess()) {
             displayDataOnTable(res);
         }else {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         ...
         if(questionsResult.isEmpty()) {
           ...
           Response.ExamResult res = examController.addQuestionToTheTest(questionsResult,this.ExamQuestionCode);
           if(res.isIsSuccess()) {
            JOptionPane.showMessageDialog(null, res.getMessage());
           }else {
              JOptionPane.showMessageDialog(null, res.getMessage());
